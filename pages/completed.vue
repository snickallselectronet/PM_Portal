    ...
    <div class="container mx-auto px-4 py-8">
      <header class="mb-8 flex justify-between items-center">
        <div>
          ...
          <h1 class="text-3xl font-bold text-gray-900 mb-2">Completed Field Forms</h1>
          <p class="text-gray-600">Survey123 forms submitted by field crews after work is completed</p>
        </div>
      </header>
